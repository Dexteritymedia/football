...
seasons_ = ["2010-2011", "2011-2012", "2012-2013", "2013-2014", "2014-2015",]
...
def scrape_club_history(season):
    ...
    data =[]
    club_data = f"https://fbref.com/en/squads/47c64c55/{season}/Crystal-Palace-Stats"
    print(club_data)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        stor = os.path.join(root, f"static/data/Crystal-Palace-{season}.csv")
        print(stor)
